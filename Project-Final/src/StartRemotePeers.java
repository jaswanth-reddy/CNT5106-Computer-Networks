...
public class StartRemotePeers {
    ...
    public Vector<remPeerDetails> peerInfoVector;

    public void getConfiguration()
    {
        String st;
        int i1;
        peerInfoVector = new Vector<remPeerDetails>();
        try {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < myStart.peerInfoVector.size(); i++) {
                remPeerDetails pInfo = (remPeerDetails) myStart.peerInfoVector.elementAt(i);
